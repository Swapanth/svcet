...
<!-- <h2>News</h2>
                    ...
                    <div class="owl-carousel owl-theme dots-modern" data-plugin-options="{'items': 1, 'loop': true, 'margin': 20, 'autoplay': true, 'autoplayTimeout': 4000}">
                        <div>
                            <div class="thumb-info thumb-info-side-image thumb-info-no-zoom thumb-info-no-borders thumb-info-bottom-info thumb-info-no-borders-radius">
                                <div class="thumb-info-side-image-wrapper">
                                    <img src="img/news.jpg" class="img-fluid" alt="hello">
                                </div>
                                <div class="thumb-info
                            -caption">
                                    <h4 class="font-weight-semibold line-height-4 text-4 mb-1" style="text-align: left;">Latest News</h4>
                                    <p class="mb-0" style="text-align: left;"></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="thumb-info
                        thumb-info-side-image thumb-info-no-zoom thumb-info-no-borders thumb-info-bottom-info thumb-info-no-borders-radius">
                                <div class="thumb-info-side-image-wrapper">
                                    <img src="img/news.jpg" class="img-fluid" alt="hello ">
                                </div>
                                <div class="thumb-info
                    ...
                    <div class="col-12 mb-4">
                        <div class="recent-posts">
                            <article class="post">
                                ...
                                <p class="mb-0" style="text-align: left;">SVCET NSS union conducted the rally in our engineering campus on the event of constitution day on 26th Nov of every year
                                    <a href="soon.php" class="read-more font-weight-bold text-2">read more <i class="fas fa-chevron-right text-1 ms-1"></i></a>
                                </p>
                            </article>
                        </div>
...
<div class="container appear-animation" data-appear-animation="fadeInUpShorter">
    ...
    <h2 >Latest News</h2>
        ...
        <div class="col-md-6 order-1 order-md-2 text-center text-md-start mb-5 mb-md-0">
            ...
            <p class="mb-4">SVCET NSS union conducted the rally in our engineering campus on the
