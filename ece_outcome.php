                                ...
                                <div class="post-content ms-0">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>PEO-1</td>
                                                <td>Shall excel as practicing engineers, academicians and researchers.</td>
                                            </tr>
                                            <tr>
                                                <td>PEO-2</td>
                                                <td>Shall play a vital role in the nation’s infrastructural and sustainable development.</td>
                                            </tr>
                                            <tr>
                                                <td>PEO-3</td>
                                                <td>Shall hold professional and ethical responsibilities as engineers, entrepreneurs and leaders through life-long learning.</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
