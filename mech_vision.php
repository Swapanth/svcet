                        ...
                        <div class="blog-posts single-post">
                            <article class="post post-large blog-single-post border-0 m-0 p-0">
                                <div class="post-content ms-0">
                                    <h3 class="font-weight-semibold mb-3">Vision</h3>
                                    <p>Emerge as a Center of pre-eminence in Mechanical Engineering education, research and services.</p>
                                </div>
                                <div class="post-content ms-0">
                                    <h3 class="font-weight-semibold mb-3">Mission</h3>
                                    <div class="container">
                                        <h5>M1:</h5>
                                        <p>To produce graduates with scientific and technical knowledge and excellent mechanical engineering skills for professional practice, employment, advanced study and research.</p>
                                    </div>
                                    <div class="container">
                                        <h5>M2:</h5>
